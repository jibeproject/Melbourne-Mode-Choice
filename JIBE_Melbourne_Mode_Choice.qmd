...
So, we see 'Walked the dog was cited approximate 3,500 times as a purpose for origin and destination.  To see how such trips may be referenced using the higher level purpose and place variables, let's explore more:
